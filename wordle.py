...
if __name__ == "__main__":
    ...
    results = word_with_char(vocab=vocab, history=history, char='t', char_idx=4)
    ...
    results = word_with_char(vocab=results, history=history, char='s', not_char_idx=3)
